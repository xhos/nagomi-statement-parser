...
const file_nagomi_v1_dashboard_proto_rawDesc = "" +
	...
	"\rNetWorthPoint\x12%\n" +
	"\x04date\x18\x01 \x01(\v2\x11.google.type.DateR\x04date\x12/\n" +
	"\tnet_worth\x18\x02 \x01(\v2\x12.google.type.MoneyR\bnetWorthB\x9d\x01\n" +
	"\rcom.nagomi.v1B\x0eDashboardProtoP\x01Z7nagomi-statement-parser/internal/gen/nagomi/v1;nagomiv1\xa2\x02\x03NXX\xaa\x02\tNagomi.V1\xca\x02\tNagomi\\V1\xe2\x02\x15Nagomi\\V1\\GPBMetadata\xea\x02\n" +
